...
SELECT
    ...
    LW.TOTPRESENZAMINUTI AS MINUTI_PRESENZA,
    LW.TOTLAVORAZIONEMINUTI AS MINUTI_LAVORATI,
    LW.TOTPAUSAMINUTI AS MINUTI_PAUSA,
    LW.TOTECOPUREMINUTI AS MINUTI_ECONOMIA
