...
parsed_data AS (
    SELECT
        ...
        CAST(parsed_payload.data.email AS STRING)         AS email_desc,
        CAST(parsed_payload.data.name AS STRING)          AS name_,
        CAST(parsed_payload.data.surname AS STRING)       AS surname,
        CAST(parsed_payload.data.username AS STRING)      AS username,
        CAST(parsed_payload.data.placepk AS INT64)        AS place_pk,
        CAST(parsed_payload.data.userid AS INT64)         AS user_id,
